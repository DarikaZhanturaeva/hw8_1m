...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Thor thor = new Thor(280, 15, "Алексей");
        Witcher witcher = new Witcher(250, 10, "Аслан");
        Hacker hacker = new Hacker(230, 10,"Baiel");
        Hero[] heroes = {warrior1, warrior2, doc, magic, berserk, assistant, thor, witcher,hacker};
